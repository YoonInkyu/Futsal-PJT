...
<body>
	...
	<div class="container">
		...
		<div class="modal-footer d-flex justify-content-around">
			<button style="width: 10rem;" type="button" class="btn btn-outline-primary" onclick="location.href='insertTeamApply?teamCode=${teamCode}&memberCode=${memberCode }'">가입 신청</button>
