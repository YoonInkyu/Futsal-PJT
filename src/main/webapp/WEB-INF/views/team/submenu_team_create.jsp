					...
					<div class="col-8">
						...
						<div class="row">
							<div class="input-group mt-3">
								<label class="input-group-text bg-primary text-white" for="inputGroupFile01">팀 대표 이미지 등록</label> <input type="file" class="form-control" id="inputGroupFile01" name="teamLogo" onchange="readURL(this);">
								<!-- 업로드되는 팀로고 미리보기 -->
