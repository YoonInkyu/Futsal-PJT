...
<form action="/mercenary/recruitReg" method="post">
	<div class="row">
		<div class="col-12 mb-5">
			...
			<select class="form-select" aria-label="Default select example" name="mercenaryBoardLocation">
		...
		<div class="col-12 mb-5">
			...
			<input type="date" name="mercenaryBoardDate" class="form-control" id="selectDate">
		</div>
		<div class="col-12 mb-5">
			<label for="selectTime" class="form-label">매치 시작 시간?</label>
			<input type="time" name="mercenaryBoardStartTime" class="form-control" id="selectTime" min="09:00:00" max="24:00:00">
		</div>
		<div class="col-12 mb-5">
			<label for="selectTime" class="form-label">매치 끝나는 시간?</label>
			<input type="time" name="mercenaryBoardEndTime" class="form-control" id="selectTime" min="09:00:00" max="24:00:00">
		</div>
		<div class="col-12 mb-5">
			<div class="row">
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="mercenaryBoardPosible" id="inlineRadio1" value="1" checked>
