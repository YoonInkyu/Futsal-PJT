			...
			<div class="row">
				<div class="col mx-auto">
						...
						<div class="input-group mb-5">
							...
							<input type="file" class="form-control" id="inputGroupFile01" name="memberImg" value="memberImg" onchange="readURL(this);">
								<!-- 업로드되는 회원사진 미리보기 -->
						...
						<div class="d-grid mb-5">
							<input class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#changePwModal" value="비밀번호변경">
						</div>
						<div class="col-12 mb-5">
							<label for="inputName" class="form-label">이름</label> 
							<input type="text" class="form-control" id="memberName" name="memberName" required value="${member.memberName }">
						...
						<div class="col-12 mb-5">
							...
							<input type="text" class="form-control" id="memberBirth" name="memberBirth" readonly value="${member.memberBirth }">
						</div>
						<div class="col-12 mb-5">
							<div class="form-check form-check-inline">
								<input class="form-check-input gender" type="radio" id="inlineRadio1" name="memberGender" value="남자" disabled <c:if test="${member.memberGender eq '남자'}">checked</c:if>>
								<label class="form-check-label" for="inlineRadio1">남</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input gender" type="radio" id="inlineRadio2" name="memberGender" value="남자" disabled <c:if test="${member.memberGender eq '여자'}">checked</c:if>>
						...
						<div class="col-12 mb-5">
							...
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" id="inlineCheckbox1" value="공격" name="position" <c:if test="${member.position eq '공격'}">checked</c:if>> 
								<label class="form-check-label align-middle pt-1" for="inlineCheckbox1">공격</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" id="inlineCheckbox2" value="수비" name="position" <c:if test="${member.position eq '수비'}">checked</c:if>> 
								<label class="form-check-label align-middle pt-1" for="inlineCheckbox2">수비</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" id="inlineCheckbox3" value="키퍼" name="position" <c:if test="${member.position eq '키퍼'}">checked</c:if>> 
								<label class="form-check-label align-middle pt-1" for="inlineCheckbox3">키퍼</label>
							</div>
						</div>
    ...
    <div class="modal-content">
      ...
      <form action="/member/changePw" method="post" id="changePwForm">
        <div class="form-floating mb-3">
  			<input type="password" class="form-control" id="oldMemberPw" placeholder="Password" name="oldMemberPw" required>
		...
		<div class="form-floating">
  			<input type="password" class="form-control" id="memberPwCheck" placeholder="Password" required>
		...
		<div class="col-12 d-grid mt-3">
        	<input type="button" class="btn btn-primary disabled" value="변 경 하 기" id="changePwButt">
        </div>
