...
<body>
		...
		<div class="container">
			...
			<div class="profile-teaser row">
				...
				<div class="col-6">
					...
					<h1 class="name font-weight-bold mb-3">박 성 환</h1>
					...
					<div class="mx-5 mb-4">
						<div class="mb-3">아이디 : admin</div>
						<div class="mb-3">생 일 : 810101</div>
						<div class="mb-3">성별 : 남자</div>
						<div class="mb-3">연락처 : 010-3333-3333</div>
					</div>

					<div class="mb-4 d-grid col-6">
						<button class="btn btn-primary ">개인 정보 수정</button>
					</div>
	...
	<div class="m-5">
		<h1 style="border-bottom: 3px solid gray;">팀 소개</h1>
	</div>
...
<!-- 팀 소속이 없을때 이미지 및 팀 찾기 -->
	...
	<img alt="" src="/resources/img/member/${member.memberImgAttachedName }">
	<br> ${member.memberId }
	<br> ${member.memberName }
	<br> ${member.memberBirth }
	<br> ${member.memberGender }
	<br> ${member.memberTell }
	<br> ${member.position }
	<br> ${member.teamName }
	<br>
