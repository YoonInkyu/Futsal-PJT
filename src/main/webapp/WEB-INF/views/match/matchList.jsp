						...
						<div class="col-2">
							<select class="form-select form-select" aria-label=".form-select-lg example" name="searchLocation">
								...
								<c:if test="${matchVO.searchLocation != null }">
									...
									<option value="인천" <c:if test="${matchVO.searchLocation == '인천'}">selected</c:if>>인천</option>
									...
									<option value="부산" <c:if test="${matchVO.searchLocation == '부산'}">selected</c:if>>부산</option>
									<option value="광주" <c:if test="${matchVO.searchLocation == '광주'}">selected</c:if>>광주</option>
									<option value="울산" <c:if test="${matchVO.searchLocation == '울산'}">selected</c:if>>울산</option>
								</c:if>
							</select>
						</div>
						<div class="col-3">
