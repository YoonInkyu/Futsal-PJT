				...
				<div class="col mx-auto mt-3">
					...
					<div class="row mb-5">
						...
						<div class="form-floating">
							<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="contentNotice" style="height: 30rem;" onkeyup="contentNotice_checkByte(this);" required></textarea>
