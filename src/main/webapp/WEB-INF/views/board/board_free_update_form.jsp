	...
	<div class="container">
		...
		<form action="/board/updateBoardFree" method="post" enctype="multipart/form-data">
			...
			<div class="col-8 mx-auto mt-3">
				...
				<!-- 						<label for="fileNameFree" class="form-label">파 일 등 록</label> <input type="file" class="form-control" name="fileNameFree" value="${freeInfo.fileNameFree }> -->
				<!-- 					</div> -->
				...
				<div class="row mb-5">
					...
					<div class="form-floating">
						<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="contentFree" style="height: 300px" onkeyup="contentFree_checkByte(this);" required>${freeInfo.contentFree }</textarea>
