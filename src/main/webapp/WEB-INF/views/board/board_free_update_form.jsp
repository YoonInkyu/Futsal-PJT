			...
			<div class="col-8 mx-auto mt-3">
				...
				<div class="row mb-5">
					...
					<div class="form-floating">
						<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="contentFree" style="height: 300px" required>${freeInfo.contentFree }</textarea>
